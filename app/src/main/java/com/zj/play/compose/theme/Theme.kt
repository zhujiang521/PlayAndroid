...
fun BlueTheme(
    ...
    PlayTheme(darkTheme, colors, content)
}
...
private val LightImages = Images(lockupLogo = R.drawable.logo_reverse)

private val DarkImages = Images(lockupLogo = R.drawable.logo_reverse)

@Composable
private fun PlayTheme(
    darkTheme: Boolean,
    colors: Colors,
    content: @Composable () -> Unit
) {
